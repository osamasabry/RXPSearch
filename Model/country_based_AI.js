...
var rxp_CountryBasedAISchema = mongoose.Schema({
    ...
    CountryBasedAI_Administration_IV  		 	   :String,
    CountryBasedAI_Administration_Injectable_Detail:String,
    ...
    CountryBasedAI_Storage_Stability			   :String,
    CountryBasedAI_Compatibility				   :String,
